class OrderAddress
  ...
  attr_accessor :token, :postal_code, :prefecture_id, :municipality, :address, :phone_number, :building, :user_id, :item_id, :card_number, :card_exp_month, :card_exp_year, :card_cvc
